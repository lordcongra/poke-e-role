    ...
    if (custom) {
        const finalAcc1 =
            custom.acc1Alt && custom.acc1Alt !== 'none' && custom.acc1Alt !== ''
                ...
                : custom.acc1;
        const finalAcc2 =
            custom.acc2Alt && custom.acc2Alt !== 'none' && custom.acc2Alt !== ''
                ? `${custom.acc2}/${custom.acc2Alt}`
                : custom.acc2;
        const finalDmg1 =
            custom.dmg1Alt && custom.dmg1Alt !== 'none' && custom.dmg1Alt !== ''
                ? `${custom.dmg1}/${custom.dmg1Alt}`
                : custom.dmg1;
