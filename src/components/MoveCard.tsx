        ...
        >
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'nowrap' }}>
                <input
                    ...
                    style={{ cursor: 'pointer', transform: 'scale(1.4)', flexShrink: 0, margin: '0 4px' }}
                ...
                <button
                    ...
                    style={{ color: 'var(--primary)', padding: '4px', fontSize: '1.2rem', flexShrink: 0 }}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                ...
                >
                    <span style={{ fontSize: '0.8rem', fontWeight: 'bold', color: 'var(--text-muted)', width: '35px' }}>
                        ACC:
                    </span>
                    <select
                        value={move.acc1}
            ...
            >
                ...
                <div style={{ display: 'flex', gap: '6px' }}>
                    <button
                        ...
                        style={{ height: '32px', width: '36px', fontSize: '1rem' }}
                    >
                        ▲
                    </button>
                    <button
