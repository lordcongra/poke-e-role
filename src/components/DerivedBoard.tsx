                ...
                <div className="derived-board__health-row">
                    <div className="derived-board__health-box">
                        <ResourceBox
                            ...
                            base={health.hpBase}
                            color="var(--primary)"
                            onCurrChange={(value) => updateHealth('hpCurr', value)}
                            onBaseChange={(value) => updateHealth('hpBase', value)}
                        />
                    </div>
                    <div className="derived-board__health-box">
                        <ResourceBox
                            ...
                            base={will.willBase}
                            color="#2196F3"
                            onCurrChange={(value) => updateWill('willCurr', value)}
                            onBaseChange={(value) => updateWill('willBase', value)}
                        />
                    </div>
                    <StatusBox />
                </div>
                    ...
                    <div className="sheet-panel health-section__box derived-board__box">
                        ...
                        <div className="derived-board__box-content">
                            ...
                            <NumberSpinner
                                ...
                                onChange={(value) => setDerived('defBuff', Number(value) || 0)}
                                min={0}
                            />
                            <span className="derived-board__minus">-</span>
                            <NumberSpinner
                                value={derived.defDebuff}
                                onChange={(value) => setDerived('defDebuff', Number(value) || 0)}
                                min={0}
                            />
                        </div>
                    </div>
                    ...
                    <div className="sheet-panel health-section__box derived-board__box">
                        ...
                        <div className="derived-board__box-content">
                            ...
                            <NumberSpinner
                                ...
                                onChange={(value) => setDerived('sdefBuff', Number(value) || 0)}
                                min={0}
                            />
                            <span className="derived-board__minus">-</span>
                            <NumberSpinner
                                value={derived.sdefDebuff}
                                onChange={(value) => setDerived('sdefDebuff', Number(value) || 0)}
                                min={0}
                            />
                        </div>
                    </div>
                        ...
                        <>
                            ...
                            <div className="sheet-panel health-section__box derived-board__box derived-board__box--yellow-border">
                                ...
                                <div className="derived-board__box-content">
                                    <NumberSpinner
                                        value={derived.happy}
                                        onChange={(value) => setDerived('happy', value)}
                                        min={0}
                                        max={5}
                                    />
                                </div>
                            ...
                            <div className="sheet-panel health-section__box derived-board__box derived-board__box--purple-border">
                                ...
                                <div className="derived-board__box-content">
                                    <NumberSpinner
                                        value={derived.loyal}
                                        onChange={(value) => setDerived('loyal', value)}
                                        min={0}
                                        max={5}
                                    />
                                </div>
