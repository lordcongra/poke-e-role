        ...
        <CollapsingSection title="SOCIAL ATTRIBUTES">
                            ...
                            return (
                                <tr key={statistic} className="data-table__row--dynamic">
                                    ...
                                    <td className="data-table__cell--middle">
                                        <NumberSpinner
                                            value={data.base}
                                            onChange={(value) => setSocialStatistic(statistic, 'base', value)}
                                            min={1}
                                        />
                                    </td>
                                    <td className="data-table__cell--middle">
                                        <NumberSpinner
                                            value={data.rank}
                                            onChange={(value) => setSocialStatistic(statistic, 'rank', value)}
                                            min={0}
                                        />
                                    </td>
                                    <td className="data-table__cell--middle">
                                        <NumberSpinner
                                            value={data.buff}
                                            onChange={(value) => setSocialStatistic(statistic, 'buff', value)}
                                            min={0}
                                        />
                                    </td>
                                    <td className="data-table__cell--middle">
                                        <NumberSpinner
                                            value={data.debuff}
                                            onChange={(value) => setSocialStatistic(statistic, 'debuff', value)}
                                            min={0}
                                        />
                                    </td>
            ...
            <div className="social-table__footer">
                ...
                <span className="social-table__extra-container">
                    Extra:{' '}
                    <NumberSpinner value={extras.social} onChange={(value) => setExtra('social', value)} min={0} />
                </span>
            </div>
        </CollapsingSection>
    );
