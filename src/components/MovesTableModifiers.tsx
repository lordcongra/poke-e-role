        ...
        <>
            ...
            <div className="desktop-only-flex moves-table__desktop-modifiers">
                <span className="moves-table__modifier-item">
                    ...
                    />
                    :{' '}
                    <NumberSpinner value={trackers.globalAcc} onChange={(value) => updateTracker('globalAcc', value)} />
                </span>
                <span className="moves-table__modifier-item">
                    Dmg
                    <TooltipIcon
                    ...
                    />
                    :{' '}
                    <NumberSpinner value={trackers.globalDmg} onChange={(value) => updateTracker('globalDmg', value)} />
                </span>
                <span className="moves-table__modifier-item">
                    Succ
                    <TooltipIcon
