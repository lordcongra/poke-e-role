        ...
        <CollapsingSection title="CORE ATTRIBUTES">
                            ...
                            return (
                                <tr key={statistic} className="data-table__row--dynamic">
                                    ...
                                    <td className="data-table__cell--middle">
                                        <NumberSpinner
                                            value={data.base}
                                            onChange={(value) => setStatistic(statistic, 'base', value)}
                                            min={1}
                                        />
                                    </td>
                                    <td className="data-table__cell--middle">
                                        <NumberSpinner
                                            value={data.limit}
                                            onChange={(value) => setStatistic(statistic, 'limit', value)}
                                            min={1}
                                        />
                                    </td>
                                    <td className="data-table__cell--middle">
                                        <NumberSpinner
                                            value={data.rank}
                                            onChange={(value) => setStatistic(statistic, 'rank', value)}
                                            min={0}
                                        />
                                    </td>
                                    <td className="data-table__cell--middle">
                                        <NumberSpinner
                                            value={data.buff}
                                            onChange={(value) => setStatistic(statistic, 'buff', value)}
                                            min={0}
                                        />
                                    </td>
                                    <td className="data-table__cell--middle">
                                        <NumberSpinner
                                            value={data.debuff}
                                            onChange={(value) => setStatistic(statistic, 'debuff', value)}
                                            min={0}
                                        />
                                    </td>
            ...
            <div className="core-table__footer">
                ...
                <span className="core-table__extra-container">
                    Extra: <NumberSpinner value={extras.core} onChange={(value) => setExtra('core', value)} min={0} />
                </span>
            </div>
        </CollapsingSection>
    );
