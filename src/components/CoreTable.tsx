            ...
            {!isCollapsed && (
                <div className="panel-content-wrapper">
                                    ...
                                    return (
                                        <tr key={stat} className="data-table__row--dynamic">
                                            ...
                                            <td className="data-table__cell--middle">
                                                <NumberSpinner
                                                    value={data.base}
                                                    onChange={(v) => setStat(stat, 'base', v)}
                                                    min={1}
                                                />
                                            </td>
                                            <td className="data-table__cell--middle">
                                                <NumberSpinner
                                                    value={data.limit}
                                                    onChange={(v) => setStat(stat, 'limit', v)}
                                                    min={1}
                                                />
                                            </td>
                                            <td className="data-table__cell--middle">
                                                <NumberSpinner
                                                    value={data.rank}
                                                    onChange={(v) => setStat(stat, 'rank', v)}
                                                    min={0}
                                                />
                                            </td>
                                            <td className="data-table__cell--middle">
                                                <NumberSpinner
                                                    value={data.buff}
                                                    onChange={(v) => setStat(stat, 'buff', v)}
                                                    min={0}
                                                />
                                            </td>
                                            <td className="data-table__cell--middle">
                                                <NumberSpinner
                                                    value={data.debuff}
                                                    onChange={(v) => setStat(stat, 'debuff', v)}
                                                    min={0}
                                                />
                                            </td>
                                            <td
                    ...
                    >
                        ...
                        <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                            Extra: <NumberSpinner value={extras.core} onChange={(v) => setExtra('core', v)} min={0} />
                        </span>
                    </div>
                </div>
            )}
